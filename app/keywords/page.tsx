...
export default async function KeywordsPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      <div className="mb-8">
        <h1 className="text-sm font-medium tracking-tight text-neutral-900 dark:text-neutral-100">关键词</h1>
        <p className="mt-1 text-xs text-neutral-400">订阅关键词,自动采集相关视频并解析。</p>
      </div>
