...
export default async function CreatorsPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-8 py-10">
      <div className="mb-8">
        <h1 className="text-lg font-bold tracking-tight text-neutral-900 dark:text-neutral-100">博主</h1>
        <p className="mt-1 text-xs text-neutral-500">订阅博主，自动采集视频并解析。</p>
      </div>
      <section className="mb-6"><CrawlConfigForm scope="creator" /></section>
