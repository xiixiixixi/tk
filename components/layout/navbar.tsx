...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-neutral-200 bg-[#F5F4F0]/90 backdrop-blur-sm dark:border-neutral-800 dark:bg-[#0D0D0D]/90">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-8">
        <Link href="/videos" className="text-sm font-bold tracking-tight text-neutral-900 dark:text-neutral-100">
          脚本分析
        </Link>
