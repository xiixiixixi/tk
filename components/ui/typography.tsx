...
const H1 = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h1 ref={ref} className={cn("text-2xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100", className)} {...props} />
  )
);
H1.displayName = "H1";
...
const H2 = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h2 ref={ref} className={cn("text-lg font-bold tracking-tight text-neutral-900 dark:text-neutral-100", className)} {...props} />
  )
);
H2.displayName = "H2";
...
const H3 = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("text-sm font-bold text-neutral-900 dark:text-neutral-100", className)} {...props} />
  )
);
H3.displayName = "H3";
...
const Divider = React.forwardRef<HTMLHRElement, React.HTMLAttributes<HTMLHRElement>>(
  ({ className, ...props }, ref) => (
    <hr ref={ref} className={cn("border-neutral-200 dark:border-neutral-800", className)} {...props} />
  )
);
